...
## 2026-04-18 - Dynamic Chat Auto-Scroll Accessibility
**Learning:** Adding auto-scroll functionality to a chat interface is visually helpful but can leave screen reader users behind if new content isn't announced. Calling `await nextTick()` repeatedly to scroll can also be less efficient.
