...
## 2026-04-14 - Accessible Auto-scrolling
...
**Action:** When implementing an auto-scrolling log or chat UI, combine DOM `scrollTop` logic bound to a watcher with proper ARIA live region attributes to make the dynamic updates both visually correct and screen-reader accessible.
