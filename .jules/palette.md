...
## 2026-04-20 - Dynamic Chat Interface Accessibility and Auto-scrolling
**Learning:** Dynamic chat or log interfaces can be difficult to navigate for both sighted and screen-reader users if new content pushes old content out of view without tracking the bottom of the list, and if new messages aren't announced.
