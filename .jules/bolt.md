...
## 2024-05-24 - Zero-Allocation Tag Parsing
**Learning:** Replaced regex in HTML/XML tag extraction with manual string indexing to eliminate regex engine overhead and allow for zero-allocation parsing.
**Action:** Prefer strings.Index and strings.Builder for simple static tag extraction.
