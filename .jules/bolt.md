...
## 2026-04-18 - Replacing Multiple strings.ReplaceAll in maps with strings.NewReplacer
...
**Action:** Collect the key-value pairs into a `[]string` slice and perform a single-pass replacement using `strings.NewReplacer(replacements...).Replace(str)`.
