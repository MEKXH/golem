...
func (l *Loader) RenderPattern(name string, values map[string]string) (*RenderedPattern, error) {
	...
	// Collect replacements into a slice to avoid O(N) intermediate memory allocations
	// and unpredictable cascading replacements from sequential strings.ReplaceAll calls.
